...
public class P4_PantojaF {
    ...
    public static void main(String[] args) {
        ...
        int[][] pacients = new int[PACIENTSMAXIM][6]; // Cada fila conté les dades d'un pacient: TIS, simptoma,
                                                      // exploracio, nivell de prioritat, temperatura
        ...
        while (MesPacients && comptemPacients < PACIENTSMAXIM) {
            ...
            int tisActual = 0, simptomaActual = 0, exploracioActual = 0, nivellPrioritatActual = 0,
                    temperaturaActual = 0;
            ...
            if (errorDada) {
                ...
                pacients[comptemPacients][5] = comptemPacients;
        ...
        System.out.print(
                "\nVols veure l'ordre per nivell de prioritat i com será atés per ordre d'arribada ? (1 per sí, 0 per no): ");
        int priorityAndArrival = entrada.nextInt();

        if (priorityAndArrival == 1) {
            printOtherOptions(pacients);
        }
    ...
    private static void printOtherOptions(int[][] patients) {
        System.out.println("Mostrant pacients per ordre de prioritat i atés per ordre d'arribada");
    ...
    private static void printPatient(int[] patient) {
        System.out.println("TIS: " + patient[0] + ", Simptoma: " + patient[1] + ", Exploració: " + patient[2]
                + ", Nivell de prioritat: " + patient[3] + ", Temperatura: " + patient[4] + ", ordre d'arribada: "
                + patient[5]);
    }
}
